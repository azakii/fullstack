"use strict";(self.webpackChunkmy_project=self.webpackChunkmy_project||[]).push([[7172],{57172:(q,S,t)=>{t.d(S,{ProtectedListPage:()=>gt});var s=t(74081),c=t(27279),j=t(51926),E=t(27997),L=t(73354),D=t(27875),P=t(37472),h=t(32370),C=t(48102),l=t(74758),M=t(93415),$=t(70774),_=t(38566),tt=t(38101),N=t(93153),d=t(50086),K=t(73411),st=t(10989),ot=t(86967),B=t(10701),z=t(72450);const b=z.ZP.div`
...
`,h=(0,c.ZP)(j.x)`
  ...
  width: 100%;
  border: none;
`,C=({children:l,icon:M,...$})=>(0,s.jsxs)("div",{children:[(0,s.jsx)(E.i,{}),(0,s.jsx)(h,{as:"button",background:"primary100",padding:5,...$,children:(0,s.jsxs)(L.k,{children:[(0,s.jsx)(P,{"aria-hidden":!0,background:"primary200",children:M}),(0,s.jsx)(j.x,{paddingLeft:3,children:(0,s.jsx)(D.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:l})})]})})]})}}]);
